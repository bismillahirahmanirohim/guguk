...
wget -O /etc/pam.d/common-password "https://raw.githubusercontent.com/bismillahirahmanirohim/guguk/master/password.txt"
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/bismillahirahmanirohim/guguk/master/nginx.conf"
...
cd
cd
wget -O /usr/bin/badvpn-udpgw https://raw.githubusercontent.com/bismillahirahmanirohim/guguk/master/badvpn-udpgw && chmod +x  /usr/bin/badvpn-udpgw
#system badvpn 7300
wget -O /etc/systemd/system/svr-7300.service https://raw.githubusercontent.com/bismillahirahmanirohim/guguk/master/svr-7300.service && chmod +x  /etc/systemd/system/svr-7300.service
#system badvpn 7200
wget -O /etc/systemd/system/svr-7200.service https://raw.githubusercontent.com/bismillahirahmanirohim/guguk/master/svr-7200.service && chmod +x  /etc/systemd/system/svr-7200.service
#system badvpn 7100
wget -O /etc/systemd/system/svr-7100.service https://raw.githubusercontent.com/bismillahirahmanirohim/guguk/master/svr-7100.service && chmod +x  /etc/systemd/system/svr-7100.service
...
wget https://raw.githubusercontent.com/bismillahirahmanirohim/guguk/master/rules.zip
unzip rules.zip
...
echo; echo 'Installing DDOS-protevtion v.10 by wongedan_kuwibebas'; echo
...
wget -q -O /etc/wongedan.site "https://raw.githubusercontent.com/wongedann/permission/master/issue.net"
chmod +x /etc/wongedan.site
echo "Banner /etc/wongedan.site" >> /etc/ssh/sshd_config
sed -i 's@DROPBEAR_BANNER=""@DROPBEAR_BANNER="/etc/wongedan.site"@g' /etc/default/dropbear


#install bbr dan optimasi kernel
wget https://raw.githubusercontent.com/bismillahirahmanirohim/guguk/master/bbr.sh && chmod +x bbr.sh && ./bbr.sh
...
#installer OPH
wget https://raw.githubusercontent.com/bismillahirahmanirohim/guguk/master/ohp.sh && chmod +x ohp.sh && ./ohp.sh
#installer openvpn
...
mkdir /etc/error404project/
mkdir /etc/error404project/limit/
mkdir /etc/error404project/limit/vmess
mkdir /etc/error404project/limit/trojan
mkdir /etc/error404project/limit/vless
mkdir /etc/error404project/limit/vmess/ip
mkdir /etc/error404project/limit/trojan/ip
mkdir /etc/error404project/limit/vless/ip
mkdir /tmp/vless/
mkdir /tmp/vmess/
mkdir /tmp/trojan/
